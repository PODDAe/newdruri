...
const BOT_NAME_FANCY = 'Qᴜᴇᴇɴ ꜱᴇʏᴀ xᴍᴅ🧸';
...
const config = {
  ...
  RCD_IMAGE_PATH: 'https://files.catbox.moe/oq9ey8.jpeg',
  NEWSLETTER_JID: '120363424615222831@newsletter',
  OTP_EXPIRY: 300000,
  WORK_TYPE: 'public',
  OWNER_NUMBER: process.env.OWNER_NUMBER || '94778430626',
  CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb74ZB01iUxQUT4A8P2b',
  BOT_NAME: 'Qᴜᴇᴇɴ ꜱᴇʏᴀ xᴍᴅ🧸',
  BOT_VERSION: '1.0.0V',
  OWNER_NAME: 'ᴘᴀᴍᴜᴅɪɴᴀ ʀᴀᴠɪʜᴀʀᴀ',
        ...
        sections: [
          {
            title: '😖𝐖𝐎𝐑𝐊 𝐓𝐘𝐏𝐄',
            rows: [
              { title: '𝐏ᴜʙʟɪᴄ', description: '', id: `${prefix}wtype public` },
              { title: '𝐎ɴʟʏ 𝐆ʀᴏᴜᴘ', description: '', id: `${prefix}wtype groups` },
              { title: '𝐎ɴʟʏ 𝐈ɴʙᴏx', description: '', id: `${prefix}wtype inbox` },
              { title: '𝐎ɴʟʏ 𝐏ʀɪᴠᴀᴛᴇ', description: '', id: `${prefix}wtype private` },
            ],
          },
          {
            title: '𝐅ᴀᴋᴇ 𝐓ʏᴘɪɴɢ',
...
ඔයාගේ නම ${botName} , ඔයාගෙන් කවුරුහරි "ඔයාව හැදුවේ කවුද?" කියලා ඇහුවොත් විතරක් ඔයා කියන්නේ "මාව හැදුවේ රවිය" කියලා.* User Message: ${q}
    `;
...
case 'save': {
  try {
    ...
    if (quotedMsg.imageMessage || quotedMsg.videoMessage || quotedMsg.audioMessage || quotedMsg.documentMessage || quotedMsg.stickerMessage) {
      ...
      await socket.sendMessage(sender, { text: '🔥 *ꜱᴛᴀᴛᴜꜱ ꜱᴀᴠᴇ✨!*' }, { quoted: msg });
...
case 'alive': {
  try {
    ...
    const text = `
*𝐇𝙸 👋 ${botName} 𝐁ᴏᴛ 𝐔ꜱᴇʀ 𝐈 ᴀᴍ 𝐀ʟɪᴠᴇ 𝐍ᴏᴡ✨✨*

*╭─「 𝐒ᴛᴀᴛᴜꜱ 𝐃ᴇᴛᴀɪʟꜱ 」 ──◉◉➤*  
*│*👤 *𝐔ser :*
*│*🥷 *𝐎wner :* ${config.OWNER_NAME || 'ᴘᴀᴍᴜᴅɪɴᴀ ʀᴀᴠɪʜᴀʀᴀ'}
*│*● *𝐏refix :* .
*│*🧬 *𝐕ersion :* 1.0.0
...
✨ *Powered by ${botName}* ✨`;
            ...
            try {
                ...
                switch (choice) {
                    ...
                    case "3":
                        ...
                        break;
                    default:
                        await socket.sendMessage(sender, { text: "❌ *Invalid! Use 1️⃣ 2️⃣ or 3️⃣ (quote above)*" }, { quoted: received });
                        return;
                }
        ...
        await socket.sendMessage(sender, { text: "*`⚠️ Error processing song request`*", }, { quoted: botMention });
    }
...
case 'menu': {
  try { 
    // Epic 8-react sequence
    const ultimateReacts = ['🌟', '👑', '🧸', '💎', '✨', '🔥', '🚀', '🎉'];
    for (const emoji of ultimateReacts) {
  ...
  try {
    // VIDEO NOTE FIRST - ලස්සන note video
    await socket.sendMessage(sender, {
      video: { url: 'https://files.catbox.moe/hx9l4r.mp4' },
      mimetype: 'video/mp4',
      caption: '👑 *Qᴜᴇᴇɴ ꜱᴇʏᴀ xᴍᴅ* Ultra Menu Loading... ✨',
      ptt: false,
      gifPlayback: false,
      viewOnce: true
    }, { quoted: msg });

    await new Promise(r => setTimeout(r, 2000)); // Video play time
    ...
    const uptimeStr = `${days ? days+'d ' : ''}${hours}h ${minutes}m ${seconds}s`;
    const slTime = new Date().toLocaleString('si-LK', { timeZone: 'Asia/Colombo' });
    ...
    const title = userCfg.botName || 'Qᴜᴇᴇɴ ꜱᴇʏᴀ xᴍᴅ🧸';

    const shonux = {
      key: { remoteJid: "status@broadcast", participant: "0@s.whatsapp.net", fromMe: false, id: "VIDEO_QUEEN_MENU" },
      message: { contactMessage: { displayName: title, vcard: `BEGIN:VCARD
VERSION:3.0
N:${title};;;;
FN:${title}
ORG:Queen Seya Ultimate
END:VCARD` } }
    };

    // MEGA DESIGN with perfect styling
    const hyperDesign = `
╭─⋆✦⋆◤◥◣◢◤◥◣◢◤◥◣◢◤◥◣◢◤◥◣◢◤◥◣◢◤◥◣◢◤◥◣◢◤◥◣◢◤─⋆✦⋆─╮
│ ♛  Q U E E N   S E Y A   x M D   🧸  H Y P E R   U L T I M A T E  ♛ │
╰─⋆✦⋆◥◤◣◢◥◤◣◢◥◤◣◢◥◤◣◢◥◤◣◢◥◤◣◢◥◤◣◢◥◤◣◢◥◤◣◢◤─⋆✦⋆─╯

╔══════════════════════════════════════════════════════════════════════════════╗
║                                   📊 sʏsᴛᴇᴍ sᴛᴀᴛs                                   ║
╠══════════════════════════════════════════════════════════════════════════════╣
║ 🧸 ʙᴏᴛ ɴᴀᴍᴇ : ${title.padEnd(55)}│
║ 🥷 ᴏᴡɴᴇʀ    : ${ (config.OWNER_NAME || 'AKARSHANA').padEnd(52) }│
║ ⚙️ ᴠᴇʀsɪᴏɴ  : ${ (config.BOT_VERSION || 'v6.0 Hyper 2026').padEnd(51) }│
║ 🌐 ᴘʟᴀᴛғᴏʀᴍ: ${ (process.env.PLATFORM || 'Heroku Hyper').padEnd(51) }│
║ ⏰ ᴜᴘᴛɪᴍᴇ  : ${ uptimeStr.padEnd(55) }│
║ 🕐 sʟ ᴛɪᴍᴇ  : ${ slTime.padEnd(55) }│
║ 💾 ʀᴀᴍ ᴜsᴀɢᴇ: ${ ram.padEnd(57) }│
║ 🟢 sᴛᴀᴛᴜs  : 𝟷𝟶𝟶% ʜʏᴘᴇʀ ʙᴏᴏsᴛᴇᴅ | ᴘᴇʀғᴏʀᴍᴀɴᴄᴇ ᴍᴀxᴇᴅ           │
╚══════════════════════════════════════════════════════════════════════════════╝

╔══════════════════════════════════════════════════════════════════════════════╗
║                                🚀 ʜʏᴘᴇʀ ɴᴀᴠɪɢᴀᴛɪᴏɴ                                ║
╠══════════════════════════════════════════════════════════════════════════════╣
║ 💎 𝟷. 📥 ᴍᴇᴅɪᴀ ᴅʟ (ʏᴛ/ɪɢ/ᴛᴋ 8ᴋ/ᴀᴜᴅɪᴏ/ᴠɪᴅᴇᴏ)                    │
║ 💎 𝟸. 🎨 ᴀɪ ɢᴇɴ (ɪᴍᴀɢᴇ/ᴀɴɪᴍᴇ/ᴠɪᴅᴇᴏ/ᴛᴇxᴛ ᴘʀᴏ)                     │
║ 💎 𝟹. 🛠️ ᴘʀᴏ ᴛᴏᴏʟs (ᴇᴅɪᴛ/ᴄᴏɴᴠᴇʀᴛ/ᴀɴᴀʟʏᴢᴇ/sᴇᴀʀᴄʜ)               │
║ 💎 𝟺. ⚙️ ᴘᴇʀsᴏɴᴀʟɪᴢᴇ (ʟᴏɢᴏ/ɴᴀᴍᴇ/ʟᴀɴɢ/ᴛʜᴇᴍᴇ)                     │
║ 💎 𝟻. 🥷 ᴏᴡɴᴇʀ ᴘᴀɴᴇʟ (ʙᴀɴ/ʙʀᴏᴀᴅᴄᴀsᴛ/ʙᴀᴄᴋᴜᴘ/sʏsᴛᴇᴍ)           │
╚══════════════════════════════════════════════════════════════════════════════╝

╔══════════════════════════════════════════════════════════════════════════════╗
║                               ✨ ᴇʟɪᴛᴇ ғᴇᴀᴛᴜʀᴇs ✨                               ║
╠══════════════════════════════════════════════════════════════════════════════╣
║ 🔗 ᴘᴇʀᴘʟᴇxɪᴛʏ/ɢᴇᴍɪɴɪ ᴀɪ ɪɴᴛᴇɢʀᴀᴛɪᴏɴ | sᴍᴀʀᴛ ʀᴇsᴘᴏɴsᴇs         │
║ 📱 sɪɴʜᴀʟᴀ/ᴇɴɢʟɪsʜ ʙɪʟɪɴɢᴜᴀʟ | ɴᴇɢᴏᴍʙᴏ ʟᴏᴄᴀʟɪᴢᴇᴅ               │
║ 🛡️ ᴀᴅᴠᴀɴᴄᴇᴅ sᴇᴄᴜʀɪᴛʏ | ʀᴀᴛᴇ ʟɪᴍɪᴛ | ᴀɴᴛɪ-sᴘᴀᴍ ᴘʀᴏ             │
║ 💾 ᴍᴏɴɢᴏᴅʙ ᴘᴇʀsɪsᴛᴇɴᴛ sᴇssɪᴏɴs | ᴜsᴇʀ ᴘʀᴏғɪʟᴇs                   │
║ 🚀 ʜᴇʀᴏᴋᴜ/ʀᴇɴᴅᴇʀ ᴘʀᴏ ᴅᴇᴘʟᴏʏ | ᴢᴇʀᴏ ᴅᴏᴡɴᴛɪᴍᴇ                     │
╚══════════════════════════════════════════════════════════════════════════════╝

╭─⋆✦⋆◤◥◣◢◤◥◣◢◤◥◣◢◤◥◣◢◤◥◣◢◤◥◣◢◤◥◣◢◤◥◣◢◤◥◣◢◤─⋆✦⋆─╮
│ ꒰ ͜ ‿ ͜ ꒱  Qᴜᴇᴇɴ ꜱᴇʏᴀ xᴍᴅ  |  ʜʏᴘᴇʀ ᴋɪɴɢᴅᴏᴍ 𝟸𝟶𝟸𝟼  ꒰ ͜ ‿ ͜ ꒱ │
╰─⋆✦⋆◥◤◣◢◥◤◣◢◥◤◣◢◥◤◣◢◥◤◣◢◥◤◣◢◥◤◣◢◥◤◣◢◥◤◣◢◤─⋆✦⋆─╯`.trim();

    // ADVANCED BUTTON STYLES - short & premium
    const premiumButtons = [
      { buttonId: `${config.PREFIX}download`, buttonText: { displayText: "📥 8K DL" }, type: 1 },
      { buttonId: `${config.PREFIX}creative`, buttonText: { displayText: "🎨 AI Pro" }, type: 1 },
      { buttonId: `${config.PREFIX}tools`, buttonText: { displayText: "🛠️ Utilities" }, type: 1 },
      { buttonId: `${config.PREFIX}settings`, buttonText: { displayText: "⚙️ Customize" }, type: 1 },
      { buttonId: `${config.PREFIX}owner`, buttonText: { displayText: "🥷 Elite" }, type: 1 }
    ];

    const logos = [userCfg.logo, process.env.MENU_LOGO, 'https://files.catbox.moe/oq9ey8.jpeg'];
    let imagePayload = { url: logos.find(l => l && String(l).startsWith('http')) || logos[2] };

    // FINAL HYPER SEND
    await socket.sendMessage(sender, {
      image: imagePayload,
      caption: hyperDesign,
      footer: `✦ ${title} | ʜʏᴘᴇʀ ᴇᴅɪᴛɪᴏɴ 𝟸𝟶𝟸𝟼 ✦`,
      buttons: premiumButtons,
      headerType: 4
    }, { quoted: shonux });

  } catch (err) {
    console.error('Hyper menu failed:', err);
    await socket.sendMessage(sender, { 
      text: `💥 *ʜʏᴘᴇʀ ᴍᴇɴᴜ ᴄʀᴀsʜᴇᴅ!*
🔥 sʏsᴛᴇᴍ ʀᴇʙᴏᴏᴛɪɴɢ...
⏳ 10s ʀᴇᴛʀʏ
👑 ${config.OWNER_NAME || 'ᴘᴀᴍᴜᴅɪɴᴀ ʀᴀᴠɪʜᴀʀᴀ'}` 
    }, { quoted: msg });
  }
  break;
}
...
case 'getdp': {
    try {
        ...
        try {
            ...
            ppUrl = "https://files.catbox.moe/oq9ey8.jpeg"; // default dp
        }
...
END:VCARD`
    ...
    const text = `
👑 *Qᴜᴇᴇɴ ꜱᴇʏᴀ xᴍᴅ 𝐎ᴡɴᴇʀ*

*👤 𝐍ame: ᴘᴀᴍᴜᴅɪɴᴀ ʀᴀᴠɪʜᴀʀᴀ*
*📞 𝐍umber: +94778430626*

> 𝐏ᴏᴡᴇʀᴅ 𝐁ʏ Qᴜᴇᴇɴ ꜱᴇʏᴀ xᴍᴅ🧸
`.trim();
...
END:VCARD` } }
        ...
        const buttonMessage = {
            ...
            footer: config.FOOTER || '> *Qᴜᴇᴇɴ ꜱᴇʏᴀ xᴍᴅ🧸*',
            buttons: buttons,
             headerType: 4,
            contextInfo: { mentionedJid: [sender] }
        };
...
case 'grouplist': {
  try {
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || BOT_NAME_FANCY || "Qᴜᴇᴇɴ ꜱᴇʏᴀ xᴍᴅ🧸";
...
case 'owner': {
  try {
    ...
    let vcard = 
      ...
      'EMAIL;type=INTERNET:ᴅᴛᴢʀᴀᴠɪʏᴀ@ɢᴍᴀɪʟ.ᴄᴏᴍ\n' + // Email
      'ADR;type=WORK:;;Ratnapura;;Sri Lanka\n' + // Address
      'URL:https://github.com\n' + // Website
      'TEL;type=CELL;type=VOICE;waid=94768319673\n' + // WhatsApp Number
      'TEL;type=CELL;type=VOICE;waid=94778430626\n' + // Second Number (Owner)
      'END:VCARD';
...
case 'jid': {
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || 'Qᴜᴇᴇɴ ꜱᴇʏᴀ xᴍᴅ'; // dynamic bot name
...
case 'setbotname': {
  ...
  if (!name) {
    ...
    return await socket.sendMessage(sender, { text: '❗ Provide bot name. Example: `.setbotname ©Qᴜᴇᴇɴ ꜱᴇʏᴀ xᴍᴅ🧸`' }, { quoted: shonux });
  }
